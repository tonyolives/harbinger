...
Conventions for any AI coding agent working on this repo. Read this and `docs/BUILD_PLAN.md` before writing code.
...
2. **One phase at a time** from `docs/BUILD_PLAN.md`. Don't start a phase until the previous one is green.
...
8. **Don't add dependencies** outside `docs/TECH_STACK.md` without a one-line justification.
...
## Stack
Spring Boot 3.2, Java 17, Maven. React 18 + Vite frontend. Full list and rationale: `docs/TECH_STACK.md`. Don't reach outside it.
